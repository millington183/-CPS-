...
*  \param  control_id 控件ID
*/
void Record_GetData(uint16 screen_id,uint16 control_id,uint16 line)
{
    BEGIN_CMD();
    TX_8(0xB1);
    TX_8(0x56);
...
*  \param  control_id 控件ID
*/
void Record_ModifyData(uint16 screen_id,uint16 control_id,uint16 line,uint8 *record)
{
    BEGIN_CMD();
    TX_8(0xB1);
    TX_8(0x57);
...
*           line     行号
*/
void Record_DelData(uint16 screen_id,uint16 control_id,uint16 line)
{
    BEGIN_CMD();
    TX_8(0xB1);
    TX_8(0x58);
...
*  \param  control_id 控件ID
*           line     行号
*						record 一条记录(字符串)，子项通过分号隔开，例如：第一项;第二项;第三项;
*/
void Record_Insertion(uint16 screen_id,uint16 control_id,uint16 line,uint8 *record)
{
		BEGIN_CMD();
    TX_8(0xB1);
    TX_8(0x59);
